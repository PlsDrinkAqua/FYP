...
create_library_set -name default_emulate_libset_max \
    -timing { /home/ol521/mintNeuroCPU/library/gsclib045_svt_v4.7/gsclib045//timing/fast_vdd1v0_basicCells.lib }
...
create_rc_corner -name default_emulate_rc_corner \
    -temperature 0.0 \
    -qrc_tech /home/ol521/mintNeuroCPU/library/gsclib045_svt_v4.7/gsclib045//qrc/qx/gpdk045.tch \
    -pre_route_res 1.0 \
    -pre_route_cap 1.0 \
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { /home/ol521/mintNeuroCPU/testing/picorv32-physical-design/interm/genus_to_innovus//picorv32.default_emulate_constraint_mode.sdc }
